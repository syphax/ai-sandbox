...
**Current status:** Phase 1 (Foundation) — drawdown simulation with pre-loaded inventory, no active ordering decisions.
...
pip install duckdb==1.4.4 pyyaml numpy pandas
```
...
├── flow_viz/                     # Flow visualization prototype
...
Full specification: [prompts/scimulator-v0.2.md](prompts/scimulator-v0.2.md)
Data schema: [prompts/scimulator-data-schema.md](prompts/scimulator-data-schema.md)
